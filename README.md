...
Los documentos y fotos viven en Google Drive — el sitio nunca los aloja
directamente — pero la interfaz de Drive queda completamente oculta:
portadas, lector y descargas se ven como parte de una biblioteca propia,
no como carpetas sueltas de Drive.
...
> Las portadas de los libros y las fotos de la galería se cargan en vivo
> desde Google Drive, así que solo se ven al abrir el sitio con conexión
> a internet.
...
**📄 Lector integrado** — visor embebido sin mostrar la interfaz de
Drive, con zoom propio y aviso claro si un documento no carga.
...
| **Datos** | Google Drive (documentos e imágenes por enlace) |
...
La guía técnica completa — cómo agregar libros y fotos, cómo funciona el
ocultamiento de Drive, notas de rendimiento y de la auditoría de código —
vive en [`docs/GUIA-DE-USO.md`](docs/GUIA-DE-USO.md).

## ⚠️ Aviso

Los documentos enlazados en el catálogo son material de terceros,
alojado en Google Drive por quien mantiene esta biblioteca. Este
repositorio **no aloja ni distribuye** ningún PDF — solo el código de la
interfaz y los enlaces a ellos. Pensado para consulta y estudio personal.
Si algún enlace infringe derechos de autor, abre un *issue* para que se
retire.
